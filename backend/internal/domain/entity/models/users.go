...
var UserWhere = struct {
	...
	CompanyID: whereHelperint64{field: "`users`.`company_id`"},
...
var (
	userAllColumns            = []string{"id", "company_id", "name", "email", "password"}
	userColumnsWithoutDefault = []string{"company_id", "name", "email", "password"}
